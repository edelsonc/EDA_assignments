...
```{r}
boxplot(df_sub1$BILIRUBIN)
boxplot(df_sub1$ALBUMIN)
```
...
# perform pca
princomp(hep_numeric)
```
As we can see `r round(100 * 81.8700900/ (81.8700900 + 49.9311803  + 0.9133541 +  0.5196922),2)`% of the varience is accounted for by the first principle component.
